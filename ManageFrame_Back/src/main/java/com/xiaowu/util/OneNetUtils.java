...
public class OneNetUtils {
    ...
    public static String creatOneNetToken(String id,String accessKey) throws UnsupportedEncodingException, NoSuchAlgorithmException, InvalidKeyException {
        String version = "2020-05-29";
        String resourceName = "userid/"+id;
